...
from engine.trainer import do_train_prcc_mgn_pix as do_train
from modeling import build_model
from layers import make_loss_with_mgn
from solver import make_optimizer_fine as make_optimizer
...
def main(cfg):
    ...
    # prepare model
    model = build_model(num_classes, 'mgn')        # num_classes=751
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', type=str, default='train', help='train, test, cam')  # change train or test mode
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/prcc_mgn_pix'))
