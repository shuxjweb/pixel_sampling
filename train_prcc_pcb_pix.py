...
from engine.trainer import do_train_prcc_pcb_pix as do_train
from modeling import build_model
from layers import make_loss_with_pcb
from solver import make_optimizer_with_pcb
from solver import WarmupMultiStepLR
from engine.inference import inference_prcc_pcb
import datetime
...
def main(cfg):
    ...
    if cfg.train == 'train':
        ...
        mAP, cmc1 = inference_prcc_pcb(model, val_loader_c, num_query_c)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs_dir', type=str, default=os.path.join(working_dir, 'logs/prcc_pcb_pix/'))
